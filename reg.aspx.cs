...
public partial class reg : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "INSERT INTO [dbo].[Company]           ( [MemberName] ,[Name],[Address],[Incentive_HasStock]          ,[Password],[state],CreateDate,usertypes,EnterpriseType,typeid)  VALUES('" + Common.strFilter(user.Text) + "','','',0,'" + MD5.CreateMD5Hash(pass.Text) + "',1,'"+ DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','"+usertypes.SelectedValue+ "','" + usertypes.SelectedValue + "',2)  ";
        //Response.Write(sql);
