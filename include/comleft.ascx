<%@ Control Language="C#" AutoEventWireup="true" CodeFile="comleft.ascx.cs" Inherits="include_comleft" %>
<div  class="index_con" >
    ...
    <li class="item"><a href="">企业动态</a></li>
    <li class="item"><a href="/comindex.aspx?type=8">需求信息</a></li>
    <li class="header">帐户管理</li>
    <li class="item"><a href="" style="padding-right:20px;">联系客户经理</a></li>
    <%} %>
    <li class="item"><a href="/comindex.aspx?type=9">修改密码</a></li>
</ul>
</div>