...
public partial class comindex : System.Web.UI.Page
{
    public int typeid = 1;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            if(tblogin.Text!= Session["MemberName"].ToString())
            {
        ...
        if (tbpass.Text.Length == 0)
        {
            sql = @"UPDATE [dbo].[Company]
                   ...
                   Common.strFilter(tblianxitel.Text) + "' ,[BusinessScope] = '" + Common.strFilter(jingyingfw.Text) + "' ,[Region] = '" + ddldiqu.SelectedValue + "',[KeyAreas] ='" +
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        //hezuozt.Text = dr["KeyAreas"].ToString();
        string sql = @"UPDATE [dbo].[Company] SET   [logo] = '" + Common.strFilter(pic.Text) + "',[lianmengtype] = '" + Common.strFilter(ddlLianMengType.SelectedValue) + "',[typeid] = '" + Common.strFilter(cbtext1) + "'     WHERE ID=" + sid + "";
        int count = DBqiye.getRowsCount(sql);
        typeid = 7;
