                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server"><ContentTemplate>
                    ...
                    <table border="0" style="width:600px;height:350px;">
                        ...
                        <tr>
                            ...
                            <td  align="left">
                                <asp:TextBox name="user" type="text" id="user"  style="width:205px;" ng-model="user"  runat="server"></asp:TextBox>
                       ...
                       <%-- <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList id="usertypes" runat="server"  Height="22px" Width="246px">     
